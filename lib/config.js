...
export default class Config {
  static constants() {
    return {
      ...
      compressed_files_folder: "rkamyp_uploads_compressed", // dynamically generated and removed again after upload
      term_rows: { default: 13, max: 90, min: 1 },
      help_text:
        "rkamyp Atom Package Help. Functions:\r\n" +
        ...
        "\r\n" +
        "For more information, take a look at github.com/pycom/rkamyp-atom or docs.pycom.io\r\n"
    };
  }
  ...
  static settings() {
    return {
      ...
      open_on_start: {
        ...
        title: "Open on start",
        description:
          "Automatically open the rkamyp console and connect to the board after starting Atom",
        order: 9
      },
      safe_boot_on_upload: {
        type: "boolean",
