...
export default class Config {
  static constants() {
    return {
      ...
      help_text:
        "rkamyp2 Atom Package Help. Functions:\r\n" +
        ...
        "\r\n" +
        "For more information, take a look at github.com/pycom/rkamyp2-atom or docs.pycom.io\r\n"
    };
  }
  ...
  static settings() {
    return {
      ...
      open_on_start: {
        ...
        title: "Open on start",
        description:
          "Automatically open the rkamyp2 console and connect to the board after starting Atom",
        order: 9
      },
      safe_boot_on_upload: {
        type: "boolean",
