...
export default class AutoConnect extends EventEmitter {
  constructor(rkamyp2, terminal, settings) {
    super();
    this.terminal = terminal;
    this.rkamyp2 = rkamyp2;
  ...
  refreshIpAddresses() {
    ...
    if (addedAddresses) {
      $('#rkamyp2-address-list').removeClass('disabled');
    } else {
      $('#rkamyp2-address-list').addClass('disabled');
      $('#rkamyp2-address-list').html(
