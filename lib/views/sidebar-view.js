...
export default class SideBar extends EventEmitter {
  ...
  build(rootElement) {
    ...
    this.button_settings = $('#rkamyp2 #settings');
    this.button_settings_sub = $('#rkamyp2 #settings .subnav');
    this.settings_project_settings = $('#rkamyp2-project_settings');
    this.settings_global_settings = $('#rkamyp2-global_settings');
    this.settings_auto_connect = $('#rkamyp2-setting-autoconnect');
    ...
    this.buttonPybytes = $('#rkamyp2 #pybytes');
